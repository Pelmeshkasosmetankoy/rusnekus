...
function HomePage({ onNavigate }) {
  const tasks = [
    ...
    { id: "✍️", page: "essays", title: "Сочинения", desc: "Темы, тексты и отправка наставнику" },
...
const ESSAY_TOPICS = [
  {
    id: 1,
    title: "Какие книги становятся для человека любимыми?",
    text: `(1) Одно из самых ярких воспоминаний моего детства по какому-то капризу судьбы или закономерности её связано со Львом Николаевичем Толстым. (2) В деревенской школе, куда я пошёл учиться в первый класс осенью тысяча девятьсот тридцать второго года, приезжий учитель прочёл нам рассказ о Жилине и Костылине. (3) Это было такое потрясение, что я долго не мог ничего более слушать и воспринимать, с криком вскакивал по ночам и всё время пытался пересказать жуткую историю о двух русских солдатах, бежавших из плена, всем, кто желал её слушать. (4) Бабушка, слушая меня, не раз плакала и повторяла: «Вот она какая жизнь-то человеческая, чего только в ней не натерпелись и не натерпишься…»

(5) С тех пор я не перечитывал рассказ Льва Николаевича Толстого «Кавказский пленник», и перечитывать не буду, ибо живёт он во мне каким-то давним, отделённым от всего остального прочитанного и услышанного, ярким озарением, и мне всё ещё хочется пересказывать бесхитростную и, может быть, самую романтическую историю в нашей русской литературе. (6) Возможно, и тяга к творчеству началась с того, в детстве искоркой занявшегося желания поведать услышанное, что-то, конечно же, добавляя от себя.

(7) Самое любимое моё произведение у Льва Николаевича «Хозяин и работник». (8) Оно не только совершенно по исполнению, но ещё и поучительно для нас, ныне работающих пером, в том смысле, что в угоду литературной схеме нельзя попускаться жизненной правдой. (9) Уверен, что в исполнении большинства современных отечественных писателей «хозяин» никогда не вернулся бы спасать «работника», не замёрз бы сам, наоборот, сделал бы всё, чтоб погубить «эксплуатируемого», ибо есть он в нашем понимании «паразит», а у паразита какой может быть характер, какое «нутро»?! (10) Только тёмное, гнилое, паразитское! (11) Великий же писатель и мыслитель видел и понимал человека во всей его объёмности, со всеми его сложностями и противоречиями, порой чудовищными.

(12) Вот в этом, на мой взгляд, и заключается традиция Толстого, воспитанного, кстати сказать, на традициях той зрелой русской литературы, которая уже существовала до него и величие которой он приумножил и поднял на такую высоту, до которой надо всем нам тянуться и тянуться, чтобы заглянуть в её беспредельные глубины.

(13) За жизнь свою я перечитывал «Войну и мир» раз пять. (14) Самое яркое впечатление было, когда я читал эту книгу в госпитале. (15) Те ощущения, та боль, какие я пережил, читая «Войну и мир» на госпитальной койке, больше не повторялись. (16) Но каждое следующее прочтение романа открывало мне новые, ранее не увиденные и неизвестные «пласты», ибо сама эта книга, как Жизнь, как Земля, велика, загадочна и сложна.

(17) Лет десять назад я — наконец-то! — решился съездить в Ясную Поляну и был потрясён равнодушием и праздностью толпы, жидким потоком плавающей по аллеям, дорогам и тропинкам усадьбы. (18) Посетители чего-то жевали, фотографировались на память, хохотали, припоминали какие-то сплетни о Толстом, а главным образом — о жене его и детях…

(19) Уже в сумерках я пришёл к могиле Толстого, постоял над нею, потом дотронулся до холодной, очерствело-осенней травы ладонью и вышел на дорогу.

(20) В Тулу я шёл пешком, ещё и ещё переживал ощущения того строгого покоя, коим наполнены были леса, перелески и рощи усадьбы, той задумчивой тишины, какая осенями была здесь при Льве Николаевиче, и вот продолжилась во времени, коснулась моей души. (21) И мне тоже сделалось спокойно. (22) Суета как бы отхлынула от меня, и, казалось, уже не закрутит, не завертит более, чувство, печальное чувство зрелого возраста вселилось в меня тогда, и думалось мне, что я способен и буду делать добро, только добро…

(23) Больше я не бывал в Ясной Поляне и боюсь туда поехать, боюсь встретить жирующих, хохочущих и снимающихся на карточки праздных людей, коим всё равно где бывать, в какой «книге отзывов» ставить автограф, что слышать, лишь бы «полезно» убить время. (24) И ещё я боюсь, очень боюсь не выдержать сурового мыслителя и творца, с которым дано мне было счастье родиться в одной стране — России. (25) Живёт во мне вечное сознание любви и страха: я занимаюсь той же работой, которой занимался Он! (26) Так какая же должна быть огромная ответственность во мне и во всех нас, ныне живущих на земле, которую Он пахал, за работу, которую Он так свято, мудро и мученически выполнял?!

(По В. Астафьеву*)
*Астафьев Виктор Петрович (1924 — 2001) — выдающийся советский и российский писатель.`,
  },
  {
    id: 2,
    title: "Что необходимо делать, чтобы добиться успеха в жизни?",
    text: `НИКОГДА НЕ ГОВОРИ, ЧТО ТЫ ЧЕГО-ТО НЕ МОЖЕШЬ

(1) На стене моего домашнего кабинета висят четыре диплома. (2) Там написано, что я лучший коммерческий директор года России, победитель в конкурсе «Менеджер года России», лучший автор года России в номинации «Бизнес-литература», лучший бизнес-спикер года. (3) Мои книги самые продаваемые бизнес-книги в истории России. (4) Отраслевые рекорды компании «КонсультантПлюс» до сих пор принадлежат той коммерческой службе, которую я в своё время возглавлял. (5) График моих выступлений расписан почти на два года вперёд. (6) И у меня сейчас собственная компания.
...
(27) Двое живут в Краснодаре. (28) Женщину зовут Анна Зеликова, в 18 лет она потеряла зрение. (29) Парня зовут Арсентий Шлындров, он лишился руки в страшной аварии. (30) Человека из Белоруссии зовут Алексей Талай. (31) В шестнадцать лет он подорвался на мине времён Великой Отечественной войны, вследствие чего потерял и руки, и ноги. (32) Они мои вдохновители. (33) Они живут, хотят, могут и делают. (34) Когда я общаюсь с ними, я понимаю, что они не «люди с ограниченными возможностями». (35) Это люди с безграничными возможностями! (36) Все мы — люди с безграничными возможностями.

(37) Нужно мечтать, верить в себя и каждый день действовать-действовать-действовать. (38) Никогда не говорите, что вы можете с чем-то не справиться! (39) И не слушайте «добрых людей», которые пытаются сбить вас с пути. (40) Помните старую поговорку: «Терпение и труд все перетрут»? (41) Это абсолютная правда...

(42) Никогда не говори, что ты чего-то не можешь. (43) Каждый может всё. (44) Вы можете всё!

(По М. Батыреву*)
* Максим Батырев (род. в 1979 г.) — известный предприниматель, бизнес-тренер, бизнес-спикер, автор книг «45 татуировок менеджера», «45 татуировок личности».`,
  },
  {
    id: 3,
    title: "Что может изменить отношение человека к окружающему миру и людям?",
    text: `(1) Я хочу поведать вам историю, которая во многом определила моё отношение к миру.
...
const ESSAY_TASK_TEXT = `Напишите сочинение-рассуждение по проблеме исходного текста.
...
function EssayGate({ children }) {
  const ESSAY_PASSWORD = "котикикомпотики"; // ← впиши сюда свой код доступа к разделу сочинений
  const [unlocked, setUnlocked] = useState(() => {
    try { return localStorage.getItem("rnk-essay-unlocked") === "yes"; } catch { return false; }
  });
  const [input, setInput] = useState("");
  const [shake, setShake] = useState(false);
  ...
  const tryUnlock = () => {
    if (input.trim().toLowerCase() === ESSAY_PASSWORD.toLowerCase()) {
      try { localStorage.setItem("rnk-essay-unlocked", "yes"); } catch {}
      setUnlocked(true);
    } else {
  ...
  return (
    <TaskCard style={{ textAlign: "center", animation: shake ? "shake 0.4s ease" : "fadeUp 0.4s ease" }}>
      <div style={{ fontSize: 32, marginBottom: 12 }}>🔒</div>
      <p style={{ color: C.latte, fontSize: 14, margin: "0 0 18px" }}>Раздел сочинений защищён. Введи код доступа.</p>
      <input
        type="password"
        value={input}
        onChange={(e) => setInput(e.target.value)}
        ...
        placeholder="код доступа"
        autoFocus
        style={{ width: "100%", padding: "12px 16px", borderRadius: 11, border: `2px solid ${C.caramelBorder}`, background: "rgba(167,139,250,0.06)", fontSize: 15, color: C.espresso, outline: "none", textAlign: "center", marginBottom: 12 }}
      />
      <button onClick={tryUnlock} style={{ width: "100%", padding: "12px", borderRadius: 11, border: "none", background: `linear-gradient(135deg, ${C.caramel}, ${C.accent2})`, color: "#0d0f14", fontSize: 14, fontWeight: 700, cursor: "pointer" }}>
        Войти
      </button>
    </TaskCard>
  );
...
function EssayWriter({ topic, onBack }) {
  ...
  const send = async () => {
    ...
    try {
      const r = await fetch("/api/send-essay", {
        ...
        body: JSON.stringify({ topic: topic.title, text }),
      });
      const data = await r.json();
      if (!r.ok || data.error) throw new Error(data.error || "Ошибка отправки");
      setSent(true);
    } catch (e) {
      setError(e.message);
    } finally {
  ...
  if (sent) {
    return (
      <TaskCard style={{ textAlign: "center" }}>
        <div style={{ fontSize: 40, marginBottom: 14 }}>✅</div>
        <p style={{ color: C.espresso, fontSize: 16, fontWeight: 600, marginBottom: 8 }}>Сочинение отправлено!</p>
        <p style={{ color: C.latte, fontSize: 13, marginBottom: 20 }}>Наставник получит его и проверит.</p>
        <button onClick={onBack} style={{ padding: "12px 24px", borderRadius: 11, border: `1px solid ${C.cardBorder}`, background: "rgba(255,255,255,0.04)", color: C.espresso, fontSize: 14, cursor: "pointer" }}>
          ← К списку тем
        </button>
      </TaskCard>
    );
  ...
  return (
    <TaskCard style={{ maxWidth: 640 }}>
      <p style={{ fontSize: 16, fontWeight: 700, color: C.espresso, marginBottom: 14 }}>{topic.title}</p>

      <details style={{ marginBottom: 16 }}>
        <summary style={{ cursor: "pointer", fontSize: 13, color: C.caramel, fontWeight: 600, marginBottom: 8 }}>Текст для сочинения</summary>
        <p style={{ fontSize: 13.5, color: C.mocha, lineHeight: 1.7, whiteSpace: "pre-line", background: "rgba(255,255,255,0.03)", padding: "14px 16px", borderRadius: 10, marginTop: 8, maxHeight: 320, overflowY: "auto" }}>
          {topic.text}
        </p>
      </details>

      <details style={{ marginBottom: 18 }}>
        <summary style={{ cursor: "pointer", fontSize: 13, color: C.caramel, fontWeight: 600, marginBottom: 8 }}>Задание</summary>
        <p style={{ fontSize: 13, color: C.latte, lineHeight: 1.7, whiteSpace: "pre-line", marginTop: 8 }}>{ESSAY_TASK_TEXT}</p>
      </details>

      <p style={{ fontSize: 13, color: C.latte, marginBottom: 8 }}>
        Твоё сочинение {wordCount > 0 && <span style={{ color: wordCount < 150 ? C.wrong : C.correct }}>({wordCount} слов)</span>}
      </p>
      <textarea
        value={text}
        onChange={(e) => setText(e.target.value)}
        placeholder="Пиши сочинение здесь…"
        style={{ width: "100%", minHeight: 260, padding: "12px 14px", borderRadius: 12, border: `1px solid ${C.cardBorder}`, background: "rgba(255,255,255,0.03)", color: C.espresso, fontSize: 14, lineHeight: 1.6, resize: "vertical", outline: "none", marginBottom: 14, fontFamily: fontBody }}
      />
      {error && <p style={{ color: C.wrong, fontSize: 13, marginBottom: 12 }}>{error}</p>}
      <button onClick={send} disabled={wordCount < 50 || sending}
        style={{ width: "100%", padding: "14px", borderRadius: 12, border: "none", background: wordCount >= 50 && !sending ? `linear-gradient(135deg, ${C.caramel}, ${C.accent2})` : "rgba(255,255,255,0.05)", color: wordCount >= 50 && !sending ? "#0d0f14" : C.latte, fontSize: 15, fontWeight: 700, cursor: wordCount >= 50 && !sending ? "pointer" : "default" }}>
        {sending ? "Отправляю…" : "Отправить сочинение"}
      </button>
    </TaskCard>
  );
}

function EssaysPage({ onBack }) {
  const [topic, setTopic] = useState(null);

  return (
    <Shell>
      <TopBar onBack={topic ? () => setTopic(null) : onBack} label="Сочинения" right="" />
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "20px 20px 60px" }}>
        <EssayGate>
          {topic ? (
            <EssayWriter topic={topic} onBack={() => setTopic(null)} />
          ) : (
            <TaskCard style={{ maxWidth: 560 }}>
              <p style={{ fontSize: 13, color: C.latte, marginBottom: 16 }}>Выбери тему сочинения:</p>
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {ESSAY_TOPICS.map((t) => (
                  <button key={t.id} onClick={() => setTopic(t)}
                    style={{ textAlign: "left", padding: "14px 16px", borderRadius: 12, border: `1px solid ${C.cardBorder}`, background: "rgba(255,255,255,0.03)", color: C.espresso, fontSize: 14, lineHeight: 1.5, cursor: "pointer" }}
                    className="rnk-task-btn">
                    {t.title}
                  </button>
                ))}
